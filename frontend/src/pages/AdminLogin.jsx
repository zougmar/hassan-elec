        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16">
          ...
          <div>
            ...
            <p className="text-slate-400 text-lg max-w-sm">
              Manage services, projects, and client requests from a single dashboard.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-2 mb-8">
            ...
            />
            <span className="text-lg font-bold text-slate-800">Hassan Elec</span>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200/60 p-8 sm:p-10">
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
              <a href="/employee/login" className="text-primary-600 hover:text-primary-700 font-medium">Employee login</a>
            </p>
          </div>
        </div>
      </div>
